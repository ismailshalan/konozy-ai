...
def _extract_sku_to_principal(financial_events: Dict[str, Any]) -> Dict[str, Decimal]:
    """Extract SKU-level principal breakdown."""
...
class TestOdooFinancialMapperParity:
    ...
    def test_invoice_lines_structure(
        ...
        sku_to_principal = _extract_sku_to_principal(financial_events)
